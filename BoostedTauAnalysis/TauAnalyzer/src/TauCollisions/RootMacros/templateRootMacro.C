/*
	...
	Programs that use templateRootMacro.C: macroCopy.sh
...
#define templateRootMacro_cxx
#include "templateRootMacro.h" //this file does not exist, the line is here so that macroCopy.sh can use it to create the macros for the simulations.
