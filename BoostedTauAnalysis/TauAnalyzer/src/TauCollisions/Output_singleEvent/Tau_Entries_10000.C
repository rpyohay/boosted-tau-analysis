/*
	...
	Programs that use Tau_Entries_10000.C: macroCopy.sh
...
#define Tau_Entries_10000_cxx
#include "Tau_Entries_10000.h" //this file does not exist, the line is here so that macroCopy.sh can use it to create the macros for the simulations.
...
const string ma01("9"); //Set the a01 mass
using namespace reco;


void Tau_Entries_10000::Loop()
{
	

	TFile *file = new TFile(("Histograms_Entries_10000_h01_" + mh01 + "_a01_" + ma01 + ".root").c_str(), "RECREATE");
	file->cd();
...
// Now we draw all the histograms onto the canvases and save them as .png files
	...
	/* **SAVEAS**
	string directory = "Histograms_Entries_10000_h01_" + mh01 + "_a01_" + ma01;
