...
// Wed Aug 14 11:02:01 2013 by ROOT version 5.32/00
// from TTree LHEF/Analysis tree
// found on file: events_Tau_Entries_10000.root
//////////////////////////////////////////////////////////

#ifndef Tau_Entries_10000_h
#define Tau_Entries_10000_h
...
public :
   ...
   Tau_Entries_10000(TTree *tree=0);
   virtual ~Tau_Entries_10000();
...
#ifdef Tau_Entries_10000_cxx
Tau_Entries_10000::Tau_Entries_10000(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("events_Tau_Entries_10000.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("events_Tau_Entries_10000.root");
      }
...
Tau_Entries_10000::~Tau_Entries_10000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Tau_Entries_10000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Tau_Entries_10000::LoadTree(Long64_t entry)
{
...
void Tau_Entries_10000::Init(TTree *tree)
{
...
Bool_t Tau_Entries_10000::Notify()
{
...
void Tau_Entries_10000::Show(Long64_t entry)
{
...
Int_t Tau_Entries_10000::Cut(Long64_t entry)
{
...
#endif // #ifdef Tau_Entries_10000_cxx
