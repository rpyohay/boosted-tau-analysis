/*
	...
	Programs that use TAU_h125_a15.C: macroCopy.sh
...
#define TAU_h125_a15_cxx
#include "TAU_h125_a15.h" //this file does not exist, the line is here so that macroCopy.sh can use it to create the macros for the simulations.
