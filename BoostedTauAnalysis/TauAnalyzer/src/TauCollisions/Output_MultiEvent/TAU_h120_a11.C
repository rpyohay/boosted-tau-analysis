/*
	...
	Programs that use TAU_h120_a11.C: macroCopy.sh
...
#define TAU_h120_a11_cxx
#include "TAU_h120_a11.h" //this file does not exist, the line is here so that macroCopy.sh can use it to create the macros for the simulations.
...
const string mh01("120"); //Set the Higgs Mass
const string ma01("11"); //Set the a01 mass
using namespace reco;


void TAU_h120_a11::Loop()
{
