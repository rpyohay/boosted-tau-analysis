/*
	...
	Programs that use TAU_h120_a13.C: macroCopy.sh
...
#define TAU_h120_a13_cxx
#include "TAU_h120_a13.h" //this file does not exist, the line is here so that macroCopy.sh can use it to create the macros for the simulations.
