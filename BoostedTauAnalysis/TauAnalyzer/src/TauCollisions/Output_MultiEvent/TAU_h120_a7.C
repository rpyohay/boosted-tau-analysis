/*
	...
	Programs that use TAU_h120_a7.C: macroCopy.sh
...
#define TAU_h120_a7_cxx
#include "TAU_h120_a7.h" //this file does not exist, the line is here so that macroCopy.sh can use it to create the macros for the simulations.
...
const string ma01("7"); //Set the a01 mass
using namespace reco;


void TAU_h120_a7::Loop()
{
