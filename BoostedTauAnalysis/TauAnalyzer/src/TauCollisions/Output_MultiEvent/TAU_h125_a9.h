...
// Wed Aug 14 10:06:38 2013 by ROOT version 5.32/00
// from TTree LHEF/Analysis tree
// found on file: events_TAU_h125_a9.root
//////////////////////////////////////////////////////////

#ifndef TAU_h125_a9_h
#define TAU_h125_a9_h
...
#ifdef TAU_h125_a9_cxx
TAU_h125_a9::TAU_h125_a9(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("events_TAU_h125_a9.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("events_TAU_h125_a9.root");
      }
...
TAU_h125_a9::~TAU_h125_a9()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TAU_h125_a9::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TAU_h125_a9::LoadTree(Long64_t entry)
{
...
void TAU_h125_a9::Init(TTree *tree)
{
...
void TAU_h125_a9::Show(Long64_t entry)
{
...
Int_t TAU_h125_a9::Cut(Long64_t entry)
{
