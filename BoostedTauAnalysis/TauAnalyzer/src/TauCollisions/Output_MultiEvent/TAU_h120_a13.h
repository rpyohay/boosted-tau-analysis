...
// Tue Aug 13 17:10:30 2013 by ROOT version 5.32/00
// from TTree LHEF/Analysis tree
// found on file: events_TAU_h120_a13.root
//////////////////////////////////////////////////////////

#ifndef TAU_h120_a13_h
#define TAU_h120_a13_h
...
public :
   ...
   TAU_h120_a13(TTree *tree=0);
   virtual ~TAU_h120_a13();
...
#ifdef TAU_h120_a13_cxx
TAU_h120_a13::TAU_h120_a13(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("events_TAU_h120_a13.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("events_TAU_h120_a13.root");
      }
...
TAU_h120_a13::~TAU_h120_a13()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TAU_h120_a13::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TAU_h120_a13::LoadTree(Long64_t entry)
{
...
void TAU_h120_a13::Init(TTree *tree)
{
...
void TAU_h120_a13::Show(Long64_t entry)
{
...
Int_t TAU_h120_a13::Cut(Long64_t entry)
{
