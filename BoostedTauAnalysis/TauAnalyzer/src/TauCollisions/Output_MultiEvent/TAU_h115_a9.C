/*
	...
	Programs that use TAU_h115_a9.C: macroCopy.sh
...
#define TAU_h115_a9_cxx
#include "TAU_h115_a9.h" //this file does not exist, the line is here so that macroCopy.sh can use it to create the macros for the simulations.
