...
// Tue Aug 13 16:59:45 2013 by ROOT version 5.32/00
// from TTree LHEF/Analysis tree
// found on file: events_TAU_h115_a15.root
//////////////////////////////////////////////////////////

#ifndef TAU_h115_a15_h
#define TAU_h115_a15_h
...
public :
   ...
   TAU_h115_a15(TTree *tree=0);
   virtual ~TAU_h115_a15();
...
#ifdef TAU_h115_a15_cxx
TAU_h115_a15::TAU_h115_a15(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("events_TAU_h115_a15.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("events_TAU_h115_a15.root");
      }
...
TAU_h115_a15::~TAU_h115_a15()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TAU_h115_a15::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TAU_h115_a15::LoadTree(Long64_t entry)
{
...
void TAU_h115_a15::Init(TTree *tree)
{
...
void TAU_h115_a15::Show(Long64_t entry)
{
...
Int_t TAU_h115_a15::Cut(Long64_t entry)
{
