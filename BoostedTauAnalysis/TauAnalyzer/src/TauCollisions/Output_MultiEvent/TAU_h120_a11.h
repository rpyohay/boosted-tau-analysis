...
// Tue Aug 13 17:06:36 2013 by ROOT version 5.32/00
// from TTree LHEF/Analysis tree
// found on file: events_TAU_h120_a11.root
//////////////////////////////////////////////////////////

#ifndef TAU_h120_a11_h
#define TAU_h120_a11_h
...
public :
   ...
   TAU_h120_a11(TTree *tree=0);
   virtual ~TAU_h120_a11();
...
#ifdef TAU_h120_a11_cxx
TAU_h120_a11::TAU_h120_a11(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("events_TAU_h120_a11.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("events_TAU_h120_a11.root");
      }
...
TAU_h120_a11::~TAU_h120_a11()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TAU_h120_a11::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TAU_h120_a11::LoadTree(Long64_t entry)
{
...
void TAU_h120_a11::Init(TTree *tree)
{
...
void TAU_h120_a11::Show(Long64_t entry)
{
...
Int_t TAU_h120_a11::Cut(Long64_t entry)
{
