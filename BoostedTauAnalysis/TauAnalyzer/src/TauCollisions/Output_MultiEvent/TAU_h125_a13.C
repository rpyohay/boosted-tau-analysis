/*
	...
	Programs that use TAU_h125_a13.C: macroCopy.sh
...
#define TAU_h125_a13_cxx
#include "TAU_h125_a13.h" //this file does not exist, the line is here so that macroCopy.sh can use it to create the macros for the simulations.
...
const string mh01("125"); //Set the Higgs Mass
const string ma01("13"); //Set the a01 mass
using namespace reco;


void TAU_h125_a13::Loop()
{
