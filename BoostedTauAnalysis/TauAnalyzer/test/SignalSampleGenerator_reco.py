...
readFiles.extend([
    'root://eoscms//eos/cms/store/user/yohay/DIRNAME/Summer12_DR53X_NMSSMHiggs_gen_JOBNUM.root'
    ])
...
## # Sequence definition
## process.generation_sequence = cms.Sequence(process.pgen*process.genDiTauMuTauXSelector)
## process.simulation_sequence = cms.Sequence(process.psim)
## process.digitisation_sequence = cms.Sequence(process.pdigi)
## process.L1simulation_sequence = cms.Sequence(process.SimL1Emulator)
## process.digi2raw_sequence = cms.Sequence(process.DigiToRaw)
## process.raw2digi_sequence = cms.Sequence(process.RawToDigi)
## process.L1Reco_sequence = cms.Sequence(process.L1Reco)
## process.reconstruction_sequence = cms.Sequence(process.reconstruction)

## # Path definition
## process.gensimpath = cms.Path(process.generation_sequence*
## 			      process.simulation_sequence*
## 			      process.digitisation_sequence*
## 			      process.L1simulation_sequence*
## 			      process.digi2raw_sequence)
## process.recopath = cms.Path(process.raw2digi_sequence*
## 			    process.L1Reco_sequence*
## 			    process.reconstruction_sequence)
