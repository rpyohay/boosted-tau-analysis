...
//   //version tags
//   const string outputVTag("_v65");
//   const string dataVTag("_v65");
//   const string sigVTag("_v65");
//   const string WNJetsToLNuVTag("_v65");
//   const string TTJetsVTag("_v65");
//   const string TVTag("_v65");
//   const string DYJetsToLLVTag("_v65");
//   const string WZVTag("_v65");
//   const string ZZVTag("_v65");
//   const string WWVTag("_v65");
...
//   normRegionUpperBins.push_back(3);
//   makeMCClosurePlots("/data1/yohay/results/sigVsBkg_muHadIsoAnalysis_20fb-1_v63.root", vars, 
// 		     units, "/data1/yohay/results/dataVsMC_muHadNonIsoAnalysis_2p5fb-1_v63.root", 
// 		     20.0/2.5, normRegionLowerBins, normRegionUpperBins, 
// 		     "/data1/yohay/results/MC_closure_v63.root");
