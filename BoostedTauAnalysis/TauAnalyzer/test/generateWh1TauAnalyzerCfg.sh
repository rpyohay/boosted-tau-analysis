...
highMTIsoTauBVetoScaleMinus1SigmaAnalyzerOutputFiles=( "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_minus1SigmaBVetoScale_Wh1_a5_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_minus1SigmaBVetoScale_Wh1_a7_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_minus1SigmaBVetoScale_Wh1_a9_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_minus1SigmaBVetoScale_Wh1_a11_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_minus1SigmaBVetoScale_Wh1_a13_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_minus1SigmaBVetoScale_Wh1_a15_${version}.root" )
lowMTIsoTauBVetoScaleMinus1SigmaAnalyzerOutputFiles=( "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_minus1SigmaBVetoScale_Wh1_a5_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_minus1SigmaBVetoScale_Wh1_a7_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_minus1SigmaBVetoScale_Wh1_a9_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_minus1SigmaBVetoScale_Wh1_a11_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_minus1SigmaBVetoScale_Wh1_a13_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_minus1SigmaBVetoScale_Wh1_a15_${version}.root" )
highMTIsoTauBVetoScalePlus1SigmaAnalyzerOutputFiles=( "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_plus1SigmaBVetoScale_Wh1_a5_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_plus1SigmaBVetoScale_Wh1_a7_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_plus1SigmaBVetoScale_Wh1_a9_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_plus1SigmaBVetoScale_Wh1_a11_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_plus1SigmaBVetoScale_Wh1_a13_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_highMT_plus1SigmaBVetoScale_Wh1_a15_${version}.root" )
lowMTIsoTauBVetoScalePlus1SigmaAnalyzerOutputFiles=( "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_plus1SigmaBVetoScale_Wh1_a5_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_plus1SigmaBVetoScale_Wh1_a7_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_plus1SigmaBVetoScale_Wh1_a9_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_plus1SigmaBVetoScale_Wh1_a11_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_plus1SigmaBVetoScale_Wh1_a13_${version}.root" "${tauAnalyzerOutputFilePrefix}muHadIsoAnalysis_lowMT_plus1SigmaBVetoScale_Wh1_a15_${version}.root" )
